        ...
        <el-tab-pane label="基本信息" name="basic">
          ...
          <el-row type="flex" style="flex-wrap: wrap;">
            <el-col :md="12" v-for="(item, idx) in model.partners" :key="idx">
              ...
              <el-form-item>
                <el-button type="danger" @click="model.partners.splice(idx, 1)">删除</el-button>
              </el-form-item>
            </el-col>
          </el-row>
        </el-tab-pane>
        <el-tab-pane label="技能" name="skills">
          ...
          <el-row type="flex" style="flex-wrap: wrap;">
            <el-col :md="12" v-for="(item, idx) in model.skills" :key="idx">
              ...
              <el-form-item>
                <el-button type="danger" @click="model.skills.splice(idx, 1)">删除</el-button>
              </el-form-item>
            </el-col>
          </el-row>
        </el-tab-pane>
